...
- [ ] Re-prove a real Interface-authored kit through exact integrated Assembly `4996d524e05ff50a7305c2ebce81b81954f4ac05`, including local target-proof discharge, MorphTile READY planning, and ordered receiver application with `KIT_APPLY` PASS evidence; require independent exact-head Verification before integration.
