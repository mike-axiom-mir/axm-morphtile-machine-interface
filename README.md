...
- ASSEMBLY RECEIVER TARGET: exact integrated Assembly `4b7f89f83dff90d07ab6e70b7b40e8623579bbf1`; compatibility is claimed only for exact-head CI that checks out this receiver identity, including the producer-generated v0.5 presentation positive-control specimen that distinguishes omission, authored `false`, and numeric zero.
